            ...
            <div className={styles.content}>
                ...
                <div className={styles.gridContainer}>
                    ...
                    <img src="infraedge.png" alt="Personal URL" className={styles.gridImage} />
                        ...
                        <p className={styles.Description}>Custom app hosting made simple.Deploy apps from DockerHub or send us custom requests
Use our Better alternative platform to Vercel , for hosting web applicationsPersonalized support every step of the wayAffordable pricing & Full money-back guarantee in case of dissatisfaction.</p>
                        <a className={styles.Status} href='https://infraedge.tensorbuilds.tech/'>Know More</a>
                    </div>
                    <div className={styles.Item}>
                    <img src="WealthifyAI.jpg" alt="Personal URL" className={styles.gridImage} />
                        ...
                        <p className={styles.Description}>Leverage advanced AI algorithms and quant strategies to maximize profits for your trading journey. Get insights across all market sections with the help of accurate recommendations. Click here to access.</p>
                        <a className={styles.Status} href='https://wealthifyai-next.vercel.app/'>Know More</a>
                    </div>
                    <div className={styles.Item}>
